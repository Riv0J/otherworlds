...
@section('title')
    @lang('otherworlds.user_create') | Admin {{ config('app.name') }}
@endsection
...
@section('content')
    ...
    <form class="wrapper col-12 col-lg-8" method="POST" enctype="multipart/form-data"
        action="{{ route('user_store', ['locale' => $locale]) }}">
        @csrf
        <div class="mb-4 p-2 title">
            <div class="d-flex align-items-center gap-3">
                <i class="fa-solid fa-user-plus"></i>
                <h3 class="regular">@lang('otherworlds.create_user')</h3>
            </div>
        ...
        <div class="row col-12 mb-3">
            ...
            <div class="col-md-2 d-inline-flex">
                <select class="p-2 p-md-0" name="role_id" required>
        ...
        <div class="row col-12 mb-3">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" value="" placeholder="* * * * * * * *" name="password" required>
            </div>
        </div>
        ...
        <div class="row col-12 mb-3">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" value="" autocomplete="name" name="name"
                    required autofocus>
        ...
        <div class="row col-12 mb-3">
            ...
            <div class="col-md-2">
                <input type="date" class="form-control" name="birth_date" autofocus value="">
            </div>
        </div>
        ...
        <div class="row col-12 mb-5">
            ...
            <div class="col-md-6 d-flex flex-row gap-3">
                <div class="profile_img" style="width: min-content">
                    <img id="preview_img" src="{{ asset('users/premade/ph1.png') }}" style="aspect-ratio: 1; width: 5rem;"
                        alt="@lang('otherworlds.profile_img')">
                </div>
